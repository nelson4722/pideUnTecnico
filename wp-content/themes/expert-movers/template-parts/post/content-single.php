      ...
      <div class="article-text">
        <h3 class="single-post"><?php the_title();?></h3>
          <div class="metabox1"> 
            ...
            <span class="entry-comments"><i class="fas fa-comments"></i><?php comments_number( __('0 Comments','expert-movers'), __('0 Comments','expert-movers'), __('% Comments','expert-movers') ); ?></span>
          </div>
