...
<div class="container">
	...
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h1 class="search-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','expert-movers'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
		<?php else : ?>
			<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'expert-movers' ); ?></h1>
		<?php endif; ?>
	</header>

	<div class="content-area">
		<main id="main" class="site-main" role="main">
			<?php $layout_option = get_theme_mod( 'expert_movers_theme_options',__( 'Right Sidebar','expert-movers' ) );
				        ...
				        <div id="" class="content_area col-lg-8 col-md-8">
					    	<section id="post_section">
								...
								if ( have_posts() ) :
									...
									<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'expert-movers' ); ?></p>
									<?php
										get_search_form();
								...
								<div class="navigation">
					                <?php
					                    ...
					                    the_posts_pagination( array(
					                        'prev_text'          => __( 'Previous page', 'expert-movers' ),
					                        'next_text'          => __( 'Next page', 'expert-movers' ),
					                        'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'expert-movers' ) . ' </span>',
					                    ) );
					                ?>
